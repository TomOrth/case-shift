...
*   **Worker**: Asynchronous background job processor. Handles computationally heavy or long-running tasks such as parsing court documents, performing OCR, running LLM extraction jobs, and complex graph updates.
